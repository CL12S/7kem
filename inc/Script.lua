...
return '👨🏾‍🔧│ اصدار سورس الشيخ : *v'..version..'* \n📡'
end
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الشيخ يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
local inline = {{{text="- قـناة الـسـورس -",url="https://t.me/joinchat/AAAAAFchqvYmzjF5ipNIww"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس الشيخ](https://t.me/joinchat/AAAAAFchqvYmzjF5ipNIww)',nil,inline,msg.id_)
return false
end
...
return [[     
- سـورس الـشـيـخ -
[- قناة السورس](https://t.me/joinchat/AAAAAFchqvYmzjF5ipNIww)
[- مطور السـورس](t.me/VVVlP)
